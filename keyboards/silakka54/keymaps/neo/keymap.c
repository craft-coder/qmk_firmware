...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        KC_TRNS,  KC_NO,   UNDERS,  LEBRAC,  REBRAC,  KC_GRV,                             EXCLAM,  LANBRA,  RANBRA,  EQUAL,   AND_SI,  KC_F12,
        KC_TRNS,  BACKSL,  FORWSL,  LCURLY,  RCURLY,  ASTERI,                             QUESTI,  LBRACK,  RBRACK,  KC_SLSH, COLLON,  AT_SYM,
        KC_TRNS,  KC_NUHS, DOLLAR,  VERTIC,  TILDE,   ACCENT,                             PLUSSI,  PERCEN,  DOUBLQ,  SINGLQ,  SEMICO,  KC_TRNS,
